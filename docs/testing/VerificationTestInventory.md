...
| TR-4        | Unit                     | FR-4           | Pytest      | Yes        | Yes            | [click](https://github.com/emersonmaddock/sophros/actions/workflows/backend-ci.yml) | Weekly |
...
| TR-7        | Int                      | FR-5           | Manual      | No         | No             | [click](https://github.com/emersonmaddock/sophros/blob/main/docs/testing/04.26.26_progress_chart_test.md) | Biweekly |
| TR-8        |Unit                      | FR-3           | Pytest      | Yes        | Yes             | [click](https://github.com/emersonmaddock/sophros/blob/main/backend/tests/test_google_calendar_api.py) | Commit |

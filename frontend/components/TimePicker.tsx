...
export function TimePicker({ value, onChange, placeholder = 'Select time', validWindow, minTime, maxTime }: TimePickerProps) {
    ...
    const selectedOption = TIME_OPTIONS.find(o => o.value === value) || TIME_OPTIONS.find(o => o.label === value);
        ...
        <>
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={[styles.modalContent, { paddingBottom: insets.bottom || 24, paddingTop: 10 }]}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollArea}>
                            {filteredOptions.length === 0 ? (
                                <Text style={{ textAlign: 'center', padding: 20, color: Colors.light.textMuted }}>No valid times available</Text>
                            ) : (
                                filteredOptions.map((opt) => (
                                    ...
                                    >
                                        <Text style={[styles.timeOptionText, value === opt.value && styles.timeOptionTextSelected]}>
                                            {opt.label}
                                        </Text>
                                    </TouchableOpacity>
                                ))
